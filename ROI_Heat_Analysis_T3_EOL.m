...
[T3_EOL_AVG_SLICE,X_T3_EOL,Y_T3_EOL,DIST_T3_EOL]=IntensityAverageSlice('EOL_T3_Mem_Norm_Cropped2.tif',voxel_size,INT_RANGE);

figure(1)
imagesc(X_T3_EOL,Y_T3_EOL,DIST_T3_EOL.')
colormap jet
set(gca,'YDir','normal')
hold on
plot(X_T3_EOL,T3_EOL_AVG_SLICE,'r-','LineWidth',2)
h=colorbar;
legend('Mean')
set(get(h,'title'),'string','PDF')
xlabel('Distance Through MEA [\mum]')
ylabel('Normalized Pixel Intensity [-]')
title('Pt/Vu 30k Cycle MEA Intensity Distribution')
fig=gcf;
